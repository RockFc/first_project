...
#define ARROW_CXX_COMPILER_FLAGS "-g -O2 -fdebug-prefix-map=/build/apache-arrow-12.0.1=. -fstack-protector-strong -Wformat -Werror=format-security -D_FORTIFY_SOURCE=2 -fdiagnostics-color=always"
