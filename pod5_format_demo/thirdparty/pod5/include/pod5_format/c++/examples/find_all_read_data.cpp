...
int main(int argc, char ** argv)
{
    ...
    for (std::size_t batch_index = 0; batch_index < batch_count; ++batch_index) {
        ...
        for (std::size_t row = 0; row < batch_row_count; ++row) {
            ...
            std::cout << "read_data.predicted_scaling_scale: " << read_data.predicted_scaling_scale << "\n";
            std::cout << "read_data.predicted_scaling_shift: " << read_data.predicted_scaling_shift << "\n";
            std::cout << "\n";
