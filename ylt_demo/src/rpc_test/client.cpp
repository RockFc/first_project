...
Lazy<void> show_rpc_call() {
    ELOGV(INFO, "%s log, enter show_rpc_call", "info");
    ELOG_DEBUG << "debug log, enter show_rpc_call";
...
int main() {
    ...
    // init log
  easylog::init_log(easylog::Severity::DEBUG, "../log/hello_cli.log",false, true, 1024*1024*1024, 1, true);
